...
#define CRAFT_KEY_SPRINT GLFW_KEY_LEFT_CONTROL
...
#define CRAFT_KEY_TIMETRAVEL 'Y'
#define CRAFT_KEY_TIMEUNTRAVEL 'U'
#define CRAFT_KEY_AUTODELETE 'V'
#define CRAFT_KEY_AUTOPLACE 'C'
